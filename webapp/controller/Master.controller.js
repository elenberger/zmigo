...
sap.ui.define([
	...
	return BaseController.extend("ztelia.controller.Master", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("items").attachPatternMatched(this._onMasterMatched, this);
		 ...
		 * @private
		 */
		_onMasterMatched: function(oEvt) {
            this.getScenario(oEvt.getParameter("arguments").SC, function() {
            	 this.onRefresh();
            }.bind(this));
		...
		_createItem: function(oItem) {
			...
			this.getRouter().navTo("object", {
				SC:    this.getModel("local").getProperty("/Scenario/Scenario_key"), 
				Equnr: encodeURIComponent(oItem.getBindingContext().getProperty("Equnr")),
				Matnr: encodeURIComponent(oItem.getBindingContext().getProperty("Matnr")),
				Werks: encodeURIComponent(oItem.getBindingContext().getProperty("Werks")),
				Lgort: encodeURIComponent(oItem.getBindingContext().getProperty("Lgort")),
				Charg: encodeURIComponent(oItem.getBindingContext().getProperty("Charg"))
			}, bReplace);
		},
